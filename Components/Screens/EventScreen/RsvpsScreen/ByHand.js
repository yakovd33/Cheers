...
export default function ByHand({hideModal, id}) {
                ...
                <Card>
                    ...
                    />
                        ...
                        <Button 
                            ...
                            icon={() => (<Icon size={30} name={'group-add'} 
                            color={'white'}/>)}
                            mode="contained" 
                            onPress={() => {FirebaseUtil.AddContact(id,{name: name, phone: fixPhone(phone), guests: guests, status: 'לא הופץ', table: 0, ride: false}); hideModal()}}
                        >
